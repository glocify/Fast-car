															...
															<tr id="{{$car['reference_id']}}-tr">
																...
																<td>
																	@if($car['href'] && !empty($car['href']))
																		{{(strpos($car['href'], strtolower('hemmings'))) ? 'Hemmings' : ((strpos($car['href'], strtolower('ebay'))) ? 'Ebay' : ((strpos($car['href'], strtolower('carsforsale'))) ? 'Carsforsale' : ((strpos($car['href'], strtolower('autotrader'))) ? 'Autotrader' : '' )))}}
																	@endif
																</td>
																<!-- <td>
